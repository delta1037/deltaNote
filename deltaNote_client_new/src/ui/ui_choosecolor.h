...
public:
    ...
    void setupUi(QDialog *chooseColor)
    {
        ...
        chooseColor->setCursor(QCursor(Qt::SizeAllCursor));
        ...
        color_1_1->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        color_1_2->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        color_1_3->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        color_1_4->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        color_2_1->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        color_2_2->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        color_2_3->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        color_2_4->setCursor(QCursor(Qt::PointingHandCursor));
